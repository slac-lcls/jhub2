    ...
    async def start(self):
        ...
        if ret:
            ...
            if 'Permission denied' in stderr:
                ...
                e = web.HTTPError(511, reason="""It's <i>likely</i> your ssh keys are not initialized correctly. Please follow the instructions here - https://pswww.slac.stanford.edu/errors/JupyterHubCustomErrorPage.html and try again.""")
